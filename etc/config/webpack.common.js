...
const configWrapper = (targetConfigFunction) =>
  (env, argv) => {
...
const commonConfig = (name, hasDocument) =>
  configWrapper((vars) => {
    const tsConfigPath = vars.pathFinder(
      `${vars.appRoot}/tsconfig.json`,
    ...
    return {
      ...
      resolve: {
        ...
        alias: dependencyAliasesConverter(
          vars.manifest.dependencyAliases,
          vars,
        ),
      },
